...
\input{shear/concentration/concentration.tex}
\input{rotate/rotate.tex}
...
\input{reynolds/stream/stream.tex}
\input{reynolds/skew/skew.tex}
\input{reynolds/skewbox/skewbox.tex}
...
\input{lid/metric/metric.tex}
\input{poiseuille/poiseuille.tex}
\input{poiseuille/metric/metric.tex}
...
\input{height/height.tex}
\input{plateau/plateau.tex}

\section{Contact lines}
\input{sessile/sessile.tex}
...
\input{parabola/solid/solid.tex}
\input{shore/shore.tex}
\input{still/still.tex}
\input{still/bipolar/bipolar.tex}
...
\input{annulus/annulus.tex}
\input{wannier/wannier.tex}
\input{wannier/bipolar/bipolar.tex}
\input{wannier/stretch/stretch.tex}
