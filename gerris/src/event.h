...
#define GFS_EVENT(obj) GTS_OBJECT_CAST(obj, GfsEvent, gfs_event_class())
#define GFS_EVENT_CLASS(klass)                                                 \
  GTS_OBJECT_CLASS_CAST(klass, GfsEventClass, gfs_event_class())
#define GFS_IS_EVENT(obj) (gts_object_is_from_class(obj, gfs_event_class()))
...
#define gfs_event_is_repetitive(e)                                             \
  ((e)->step < G_MAXDOUBLE || (e)->istep < G_MAXINT)
...
#define GFS_IS_GENERIC_INIT(obj)                                               \
  (gts_object_is_from_class(obj, gfs_generic_init_class()))
...
#define GFS_INIT(obj)    GTS_OBJECT_CAST(obj, GfsInit, gfs_init_class())
#define GFS_IS_INIT(obj) (gts_object_is_from_class(obj, gfs_init_class()))
...
#define GFS_INIT_MASK(obj)                                                     \
  GTS_OBJECT_CAST(obj, GfsInitMask, gfs_init_mask_class())
#define GFS_IS_INIT_MASK(obj)                                                  \
  (gts_object_is_from_class(obj, gfs_init_mask_class()))
...
#define GFS_INIT_VORTICITY(obj)                                                \
  GTS_OBJECT_CAST(obj, GfsInitVorticity, gfs_init_vorticity_class())
#define GFS_IS_INIT_VORTICITY(obj)                                             \
  (gts_object_is_from_class(obj, gfs_init_vorticity_class()))
...
#define GFS_EVENT_SUM(obj)                                                     \
  GTS_OBJECT_CAST(obj, GfsEventSum, gfs_event_sum_class())
#define GFS_IS_EVENT_SUM(obj)                                                  \
  (gts_object_is_from_class(obj, gfs_event_sum_class()))
...
#define GFS_EVENT_SUM_DIRECTION(obj)                                           \
  GTS_OBJECT_CAST(obj, GfsEventSumDirection, gfs_event_sum_direction_class())
#define GFS_IS_EVENT_SUM_DIRECTION(obj)                                        \
  (gts_object_is_from_class(obj, gfs_event_sum_direction_class()))
...
#define GFS_EVENT_HARMONIC(obj)                                                \
  GTS_OBJECT_CAST(obj, GfsEventHarmonic, gfs_event_harmonic_class())
#define GFS_IS_EVENT_HARMONIC(obj)                                             \
  (gts_object_is_from_class(obj, gfs_event_harmonic_class()))
...
#define GFS_EVENT_STOP(obj)                                                    \
  GTS_OBJECT_CAST(obj, GfsEventStop, gfs_event_stop_class())
#define GFS_IS_EVENT_STOP(obj)                                                 \
  (gts_object_is_from_class(obj, gfs_event_stop_class()))
...
#define GFS_EVENT_SCRIPT(obj)                                                  \
  GTS_OBJECT_CAST(obj, GfsEventScript, gfs_event_script_class())
#define GFS_IS_EVENT_SCRIPT(obj)                                               \
  (gts_object_is_from_class(obj, gfs_event_script_class()))
...
#define GFS_INIT_FRACTION(obj)                                                 \
  GTS_OBJECT_CAST(obj, GfsInitFraction, gfs_init_fraction_class())
#define GFS_INIT_FRACTION_CLASS(klass)                                         \
  GTS_OBJECT_CLASS_CAST(klass, GfsInitFractionClass, gfs_init_fraction_class())
#define GFS_IS_INIT_FRACTION(obj)                                              \
  (gts_object_is_from_class(obj, gfs_init_fraction_class()))
...
#define GFS_REMOVE_DROPLETS(obj)                                               \
  GTS_OBJECT_CAST(obj, GfsRemoveDroplets, gfs_remove_droplets_class())
#define GFS_IS_REMOVE_DROPLETS(obj)                                            \
  (gts_object_is_from_class(obj, gfs_remove_droplets_class()))
...
#define GFS_REMOVE_PONDS(obj)                                                  \
  GTS_OBJECT_CAST(obj, GfsRemovePonds, gfs_remove_ponds_class())
#define GFS_IS_REMOVE_PONDS(obj)                                               \
  (gts_object_is_from_class(obj, gfs_remove_ponds_class()))
...
#define GFS_EVENT_FILTER(obj)                                                  \
  GTS_OBJECT_CAST(obj, GfsEventFilter, gfs_event_filter_class())
#define GFS_IS_EVENT_FILTER(obj)                                               \
  (gts_object_is_from_class(obj, gfs_event_filter_class()))
...
#define GFS_EVENT_LIST(obj)                                                    \
  GTS_OBJECT_CAST(obj, GfsEventList, gfs_event_list_class())
#define GFS_IS_EVENT_LIST(obj)                                                 \
  (gts_object_is_from_class(obj, gfs_event_list_class()))
