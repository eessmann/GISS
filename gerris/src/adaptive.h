...
#define GFS_ADAPT(obj)    GTS_OBJECT_CAST(obj, GfsAdapt, gfs_adapt_class())
#define GFS_IS_ADAPT(obj) (gts_object_is_from_class(obj, gfs_adapt_class()))
...
#define GFS_ADAPT_VORTICITY(obj)                                               \
  GTS_OBJECT_CAST(obj, GfsAdaptVorticity, gfs_adapt_vorticity_class())
#define GFS_IS_ADAPT_VORTICITY(obj)                                            \
  (gts_object_is_from_class(obj, gfs_adapt_vorticity_class()))

GfsEventClass *gfs_adapt_vorticity_class(void);

/* GfsAdaptStreamlineCurvature: Header */

#define GFS_IS_ADAPT_STREAMLINE_CURVATURE(obj)                                 \
  (gts_object_is_from_class(obj, gfs_adapt_streamline_curvature_class()))
...
#define GFS_ADAPT_FUNCTION(obj)                                                \
  GTS_OBJECT_CAST(obj, GfsAdaptFunction, gfs_adapt_function_class())
#define GFS_IS_ADAPT_FUNCTION(obj)                                             \
  (gts_object_is_from_class(obj, gfs_adapt_function_class()))
...
#define GFS_ADAPT_GRADIENT(obj)                                                \
  GTS_OBJECT_CAST(obj, GfsAdaptGradient, gfs_adapt_gradient_class())
#define GFS_IS_ADAPT_GRADIENT(obj)                                             \
  (gts_object_is_from_class(obj, gfs_adapt_gradient_class()))
...
#define GFS_ADAPT_ERROR(obj)                                                   \
  GTS_OBJECT_CAST(obj, GfsAdaptError, gfs_adapt_error_class())
#define GFS_IS_ADAPT_ERROR(obj)                                                \
  (gts_object_is_from_class(obj, gfs_adapt_error_class()))
...
#define GFS_ADAPT_THICKNESS(obj)                                               \
  GTS_OBJECT_CAST(obj, GfsAdaptThickness, gfs_adapt_thickness_class())
#define GFS_IS_ADAPT_THICKNESS(obj)                                            \
  (gts_object_is_from_class(obj, gfs_adapt_thickness_class()))
