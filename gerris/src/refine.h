...
#define GFS_REFINE(obj) GTS_OBJECT_CAST(obj, GfsRefine, gfs_refine_class())
#define GFS_REFINE_CLASS(klass)                                                \
  GTS_OBJECT_CLASS_CAST(klass, GfsRefineClass, gfs_refine_class())
#define GFS_IS_REFINE(obj) (gts_object_is_from_class(obj, gfs_refine_class()))
...
#define GFS_IS_REFINE_SOLID(obj)                                               \
  (gts_object_is_from_class(obj, gfs_refine_solid_class()))
...
#define GFS_REFINE_SURFACE(obj)                                                \
  GTS_OBJECT_CAST(obj, GfsRefineSurface, gfs_refine_surface_class())
#define GFS_IS_REFINE_SURFACE(obj)                                             \
  (gts_object_is_from_class(obj, gfs_refine_surface_class()))
...
#define GFS_REFINE_DISTANCE(obj)                                               \
  GTS_OBJECT_CAST(obj, GfsRefineDistance, gfs_refine_distance_class())
#define GFS_IS_REFINE_DISTANCE(obj)                                            \
  (gts_object_is_from_class(obj, gfs_refine_distance_class()))

GfsRefineClass *gfs_refine_distance_class(void);

/* GfsRefineHeight: Header */

#define GFS_IS_REFINE_HEIGHT(obj)                                              \
  (gts_object_is_from_class(obj, gfs_refine_height_class()))
