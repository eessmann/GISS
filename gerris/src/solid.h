...
enum { GFS_STATUS_UNDEFINED = 0, GFS_STATUS_SOLID = 1, GFS_STATUS_FLUID = 2 };
...
void gfs_init_solid_fractions_from_children(GfsDomain *        domain,
                                            ...
                                            gpointer data, GfsVariable *status);
...
#define GFS_SOLID(obj)    GTS_OBJECT_CAST(obj, GfsSolid, gfs_solid_class())
#define GFS_IS_SOLID(obj) (gts_object_is_from_class(obj, gfs_solid_class()))
