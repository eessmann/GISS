...
typedef void (*GfsFaceAdvectionFluxFunc)(const FttCellFace *       face,
...
struct _GfsAdvectionParams {
  ...
  void (*diffusion_solve)(GfsDomain *domain, GfsMultilevelParams *par,
                          GfsVariable *v, GfsVariable *rhs, GfsVariable *rhoc,
                          GfsVariable *axi);
};
