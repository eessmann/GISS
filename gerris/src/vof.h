...
#define GFS_VARIABLE_TRACER_VOF(obj)                                           \
  GTS_OBJECT_CAST(obj, GfsVariableTracerVOF, gfs_variable_tracer_vof_class())
#define GFS_VARIABLE_TRACER_VOF_CLASS(klass)                                   \
  GTS_OBJECT_CLASS_CAST(klass, GfsVariableTracerVOFClass,                      \
                        gfs_variable_tracer_vof_class())
#define GFS_IS_VARIABLE_TRACER_VOF(obj)                                        \
  (gts_object_is_from_class(obj, gfs_variable_tracer_vof_class()))
...
#define GFS_VARIABLE_VOF_CONCENTRATION(obj)                                    \
  GTS_OBJECT_CAST(obj, GfsVariableVOFConcentration,                            \
                  gfs_variable_vof_concentration_class())
#define GFS_IS_VARIABLE_VOF_CONCENTRATION(obj)                                 \
...
#define GFS_VARIABLE_TRACER_VOF_HEIGHT(obj)                                    \
  GTS_OBJECT_CAST(obj, GfsVariableTracerVOFHeight,                             \
                  gfs_variable_tracer_vof_height_class())
#define GFS_IS_VARIABLE_TRACER_VOF_HEIGHT(obj)                                 \
  (gts_object_is_from_class(obj, gfs_variable_tracer_vof_height_class()))
...
gdouble gfs_vof_face_fraction(const FttCellFace *face, GfsVariableTracerVOF *t);
