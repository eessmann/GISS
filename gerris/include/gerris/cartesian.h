...
#define GFS_CARTESIAN_GRID(obj)                                                \
  GTS_OBJECT_CAST(obj, GfsCartesianGrid, gfs_cartesian_grid_class())
#define GFS_IS_CARTESIAN_GRID(obj)                                             \
  (gts_object_is_from_class(obj, gfs_cartesian_grid_class()))
...
gboolean gfs_cartesian_grid_interpolate(GfsCartesianGrid *g, gdouble *p,
                                        gdouble *val);
