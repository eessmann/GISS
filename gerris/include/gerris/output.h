...
#define GFS_OUTPUT(obj) GTS_OBJECT_CAST(obj, GfsOutput, gfs_output_class())
#define GFS_OUTPUT_CLASS(klass)                                                \
  GTS_OBJECT_CLASS_CAST(klass, GfsOutputClass, gfs_output_class())
#define GFS_IS_OUTPUT(obj) (gts_object_is_from_class(obj, gfs_output_class()))
...
#define GFS_OUTPUT_SOLID_FORCE(obj)                                            \
  GTS_OBJECT_CAST(obj, GfsOutputSolidForce, gfs_output_solid_force_class())
...
#define GFS_OUTPUT_LOCATION(obj)                                               \
  GTS_OBJECT_CAST(obj, GfsOutputLocation, gfs_output_location_class())
#define GFS_IS_OUTPUT_LOCATION(obj)                                            \
  (gts_object_is_from_class(obj, gfs_output_location_class()))
...
typedef enum { GFS, GFS_TEXT, GFS_VTK, GFS_TECPLOT } GfsOutputSimulationFormat;
...
#define GFS_OUTPUT_SIMULATION(obj)                                             \
  GTS_OBJECT_CAST(obj, GfsOutputSimulation, gfs_output_simulation_class())
#define GFS_OUTPUT_SIMULATION_CLASS(klass)                                     \
  GTS_OBJECT_CLASS_CAST(klass, GfsOutputClass, gfs_output_simulation_class())
#define GFS_IS_OUTPUT_SIMULATION(obj)                                          \
  (gts_object_is_from_class(obj, gfs_output_simulation_class()))
...
#define GFS_OUTPUT_SCALAR(obj)                                                 \
  GTS_OBJECT_CAST(obj, GfsOutputScalar, gfs_output_scalar_class())
#define GFS_IS_OUTPUT_SCALAR(obj)                                              \
  (gts_object_is_from_class(obj, gfs_output_scalar_class()))
...
#define GFS_OUTPUT_SCALAR_MAXIMA(obj)                                          \
  GTS_OBJECT_CAST(obj, GfsOutputScalarMaxima, gfs_output_scalar_maxima_class())
#define GFS_IS_OUTPUT_SCALAR_MAXIMA(obj)                                       \
  (gts_object_is_from_class(obj, gfs_output_scalar_maxima_class()))
...
#define GFS_OUTPUT_SCALAR_HISTOGRAM(obj)                                       \
  GTS_OBJECT_CAST(obj, GfsOutputScalarHistogram,                               \
                  gfs_output_scalar_histogram_class())
#define GFS_IS_OUTPUT_SCALAR_HISTOGRAM(obj)                                    \
  (gts_object_is_from_class(obj, gfs_output_scalar_histogram_class()))
...
#define GFS_OUTPUT_DROPLET_SUMS(obj)                                           \
  GTS_OBJECT_CAST(obj, GfsOutputDropletSums, gfs_output_droplet_sums_class())
#define GFS_IS_OUTPUT_DROPLET_SUMS(obj)                                        \
  (gts_object_is_from_class(obj, gfs_output_droplet_sums_class()))
...
#define GFS_OUTPUT_ERROR_NORM(obj)                                             \
  GTS_OBJECT_CAST(obj, GfsOutputErrorNorm, gfs_output_error_norm_class())
#define GFS_IS_OUTPUT_ERROR_NORM(obj)                                          \
  (gts_object_is_from_class(obj, gfs_output_error_norm_class()))
...
#define GFS_IS_OUTPUT_SQUARES(obj)                                             \
  (gts_object_is_from_class(obj, gfs_output_squares_class()))
...
#define GFS_OUTPUT_STREAMLINE(obj)                                             \
  GTS_OBJECT_CAST(obj, GfsOutputStreamline, gfs_output_streamline_class())
#define GFS_IS_OUTPUT_STREAMLINE(obj)                                          \
  (gts_object_is_from_class(obj, gfs_output_streamline_class()))

GfsOutputClass *gfs_output_streamline_class(void);

/* GfsOutputParticle: Header */

#define GFS_IS_OUTPUT_PARTICLE(obj)                                            \
  (gts_object_is_from_class(obj, gfs_output_particle_class()))

GfsOutputClass *gfs_output_particle_class(void);

/* GfsOutputPPM: Header */

#define GFS_IS_OUTPUT_PPM(obj)                                                 \
  (gts_object_is_from_class(obj, gfs_output_ppm_class()))

GfsOutputClass *gfs_output_ppm_class(void);

/* GfsOutputGRD: Header */

#define GFS_IS_OUTPUT_GRD(obj)                                                 \
  (gts_object_is_from_class(obj, gfs_output_grd_class()))
...
#define GFS_OUTPUT_OBJECT(obj)                                                 \
  GTS_OBJECT_CAST(obj, GfsOutputObject, gfs_output_object_class())
#define GFS_IS_OUTPUT_OBJECT(obj)                                              \
  (gts_object_is_from_class(obj, gfs_output_object_class()))
