...
#define GFS_BC(obj) GTS_OBJECT_CAST(obj, GfsBc, gfs_bc_class())
#define GFS_BC_CLASS(klass)                                                    \
  GTS_OBJECT_CLASS_CAST(klass, GfsBcClass, gfs_bc_class())
#define GFS_IS_BC(obj) (gts_object_is_from_class(obj, gfs_bc_class()))
...
#define GFS_BC_VALUE(obj) GTS_OBJECT_CAST(obj, GfsBcValue, gfs_bc_value_class())
#define GFS_IS_BC_VALUE(obj)                                                   \
  (gts_object_is_from_class(obj, gfs_bc_value_class()))

GfsBcClass *gfs_bc_value_class(void);

/* GfsBcDirichlet: Header */

#define GFS_IS_BC_DIRICHLET(obj)                                               \
  (gts_object_is_from_class(obj, gfs_bc_dirichlet_class()))

GfsBcClass *gfs_bc_dirichlet_class(void);

/* GfsBcNeumann: Header */

#define GFS_IS_BC_NEUMANN(obj)                                                 \
  (gts_object_is_from_class(obj, gfs_bc_neumann_class()))

GfsBcClass *gfs_bc_neumann_class(void);

/* GfsBcAngle: Header */

#define GFS_IS_BC_ANGLE(obj)                                                   \
  (gts_object_is_from_class(obj, gfs_bc_angle_class()))
...
#define GFS_BC_NAVIER(obj)                                                     \
  GTS_OBJECT_CAST(obj, GfsBcNavier, gfs_bc_navier_class())
#define GFS_IS_BC_NAVIER(obj)                                                  \
  (gts_object_is_from_class(obj, gfs_bc_navier_class()))
...
struct _GfsBoundaryClass {
  ...
  void (*receive)(GfsBoundary *boundary, FttTraverseFlags flags,
                  gint max_depth);
...
#define GFS_BOUNDARY(obj)                                                      \
  GTS_OBJECT_CAST(obj, GfsBoundary, gfs_boundary_class())
#define GFS_BOUNDARY_CLASS(klass)                                              \
  GTS_OBJECT_CLASS_CAST(klass, GfsBoundaryClass, gfs_boundary_class())
#define GFS_IS_BOUNDARY(obj)                                                   \
  (gts_object_is_from_class(obj, gfs_boundary_class()))
...
#define GFS_BOUNDARY_INFLOW_CONSTANT(obj)                                      \
  GTS_OBJECT_CAST(obj, GfsBoundaryInflowConstant,                              \
                  gfs_boundary_inflow_constant_class())
#define GFS_BOUNDARY_INFLOW_CONSTANT_CLASS(klass)                              \
  GTS_OBJECT_CLASS_CAST(klass, GfsBoundaryInflowConstantClass,                 \
                        gfs_boundary_inflow_constant_class())
#define GFS_IS_BOUNDARY_INFLOW_CONSTANT(obj)                                   \
  (gts_object_is_from_class(obj, gfs_boundary_inflow_constant_class()))
...
#define GFS_BOUNDARY_OUTFLOW_CLASS(klass)                                      \
  GTS_OBJECT_CLASS_CAST(klass, GfsBoundaryOutflowClass,                        \
                        gfs_boundary_outflow_class())
#define GFS_IS_BOUNDARY_OUTFLOW(obj)                                           \
  (gts_object_is_from_class(obj, gfs_boundary_outflow_class()))

GfsBoundaryOutflowClass *gfs_boundary_outflow_class(void);

/* GfsBoundaryGradient: Header */

#define GFS_IS_BOUNDARY_GRADIENT(obj)                                          \
  (gts_object_is_from_class(obj, gfs_boundary_gradient_class()))
...
#define GFS_BOUNDARY_PERIODIC(obj)                                             \
  GTS_OBJECT_CAST(obj, GfsBoundaryPeriodic, gfs_boundary_periodic_class())
#define GFS_IS_BOUNDARY_PERIODIC(obj)                                          \
  (gts_object_is_from_class(obj, gfs_boundary_periodic_class()))
...
#define GFS_GEDGE(obj) GTS_OBJECT_CAST(obj, GfsGEdge, gfs_gedge_class())
#define GFS_GEDGE_CLASS(klass)                                                 \
  GTS_OBJECT_CLASS_CAST(klass, GfsGEdgeClass, gfs_gedge_class())
#define GFS_IS_GEDGE(obj) (gts_object_is_from_class(obj, gfs_gedge_class()))
...
#define GFS_BOX(obj) GTS_OBJECT_CAST(obj, GfsBox, gfs_box_class())
#define GFS_BOX_CLASS(klass)                                                   \
  GTS_OBJECT_CLASS_CAST(klass, GfsBoxClass, gfs_box_class())
#define GFS_IS_BOX(obj) (gts_object_is_from_class(obj, gfs_box_class()))

GfsBoxClass *gfs_box_class(void);

GfsBox *gfs_box_new(GfsBoxClass *klass);

static inline GfsDomain *gfs_box_domain(GfsBox *box) {
  GfsDomain *d;
