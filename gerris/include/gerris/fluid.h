...
#define GFS_FACE_NORMAL_VELOCITY(fa)      (GFS_STATE((fa)->cell)->f[(fa)->d].un)
#define GFS_FACE_NORMAL_VELOCITY_LEFT(fa) (GFS_STATE((fa)->cell)->f[(fa)->d].un)
...
#define GFS_FACE_FRACTION(fa)                                                  \
  (GFS_IS_MIXED((fa)->cell) ? GFS_STATE((fa)->cell)->solid->s[(fa)->d] : 1.)
#define GFS_FACE_FRACTION_LEFT(fa) GFS_FACE_FRACTION(fa)
#define GFS_FACE_FRACTION_RIGHT(fa)                                            \
  (GFS_IS_MIXED((fa)->neighbor)                                                \
...
void gfs_cell_coarse_fine(FttCell *cell, GfsVariable *v);
...
typedef gdouble (*GfsCenterGradient)(FttCell *cell, FttComponent c, guint v);
...
gdouble gfs_cell_corner_value(FttCell *cell, FttDirection *d, GfsVariable *v,
                              gint max_level);
