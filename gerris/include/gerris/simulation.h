...
#define GFS_SIMULATION(obj)                                                    \
  GTS_OBJECT_CAST(obj, GfsSimulation, gfs_simulation_class())
#define GFS_SIMULATION_CLASS(klass)                                            \
  GTS_OBJECT_CLASS_CAST(klass, GfsSimulationClass, gfs_simulation_class())
#define GFS_IS_SIMULATION(obj)                                                 \
  (gts_object_is_from_class(obj, gfs_simulation_class()))
...
#define GFS_IS_ADVECTION_AXI(obj)                                              \
  (gts_object_is_from_class(obj, gfs_advection_axi_class()))
