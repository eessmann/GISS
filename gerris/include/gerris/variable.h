...
struct _GfsVariable {
  ...
  gboolean face_source; /* whether source terms should be evaluated at cell
                           faces only */
...
#define GFS_VARIABLE(obj)                                                      \
  GTS_OBJECT_CAST(obj, GfsVariable, gfs_variable_class())
#define GFS_VARIABLE_CLASS(klass)                                              \
  GTS_OBJECT_CLASS_CAST(klass, GfsVariableClass, gfs_variable_class())
#define GFS_IS_VARIABLE(obj)                                                   \
  (gts_object_is_from_class(obj, gfs_variable_class()))
...
#define gfs_temporary_variable(d)                                              \
  (gfs_variable_new(gfs_variable_class(), (d), NULL, NULL))
...
#define GFS_IS_VARIABLE_BOOLEAN(obj)                                           \
  (gts_object_is_from_class(obj, gfs_variable_boolean_class()))
...
#define GFS_VARIABLE_TRACER(obj)                                               \
  GTS_OBJECT_CAST(obj, GfsVariableTracer, gfs_variable_tracer_class())
#define GFS_IS_VARIABLE_TRACER(obj)                                            \
  (gts_object_is_from_class(obj, gfs_variable_tracer_class()))

GfsVariableClass *gfs_variable_tracer_class(void);

/* GfsVariableResidual: header */

#define GFS_IS_VARIABLE_RESIDUAL(obj)                                          \
  (gts_object_is_from_class(obj, gfs_variable_residual_class()))
...
#define GFS_VARIABLE_FILTERED(obj)                                             \
  GTS_OBJECT_CAST(obj, GfsVariableFiltered, gfs_variable_filtered_class())
#define GFS_IS_VARIABLE_FILTERED(obj)                                          \
  (gts_object_is_from_class(obj, gfs_variable_filtered_class()))
...
#define GFS_VARIABLE_FUNCTION(obj)                                             \
  GTS_OBJECT_CAST(obj, GfsVariableFunction, gfs_variable_function_class())
#define GFS_IS_VARIABLE_FUNCTION(obj)                                          \
  (gts_object_is_from_class(obj, gfs_variable_function_class()))
...
#define GFS_IS_VARIABLE_STREAM_FUNCTION(obj)                                   \
  (gts_object_is_from_class(obj, gfs_variable_stream_function_class()))
...
#define GFS_IS_VARIABLE_AGE(obj)                                               \
  (gts_object_is_from_class(obj, gfs_variable_age_class()))
...
#define GFS_VARIABLE_AVERAGE(obj)                                              \
  GTS_OBJECT_CAST(obj, GfsVariableAverage, gfs_variable_average_class())
#define GFS_IS_VARIABLE_AVERAGE(obj)                                           \
  (gts_object_is_from_class(obj, gfs_variable_average_class()))
...
#define GFS_DERIVED_VARIABLE(obj)                                              \
  GTS_OBJECT_CAST(obj, GfsDerivedVariable, gfs_derived_variable_class())
#define GFS_IS_DERIVED_VARIABLE(obj)                                           \
  (gts_object_is_from_class(obj, gfs_derived_variable_class()))
...
#define GFS_CONSTANT(obj)                                                      \
  GTS_OBJECT_CAST(obj, GfsConstant, gfs_constant_class())
#define GFS_IS_CONSTANT(obj)                                                   \
  (gts_object_is_from_class(obj, gfs_constant_class()))
...
#define GFS_SPATIAL_SUM(obj)                                                   \
  GTS_OBJECT_CAST(obj, GfsSpatialSum, gfs_spatial_sum_class())
#define GFS_IS_SPATIAL_SUM(obj)                                                \
  (gts_object_is_from_class(obj, gfs_spatial_sum_class()))
...
#define GFS_VARIABLE_POISSON(obj)                                              \
  GTS_OBJECT_CAST(obj, GfsVariablePoisson, gfs_variable_poisson_class())
#define GFS_IS_VARIABLE_POISSON(obj)                                           \
  (gts_object_is_from_class(obj, gfs_variable_poisson_class()))

GfsVariableClass *gfs_variable_poisson_class(void);

/* GfsVariableLaplacian: Header */

#define GFS_IS_VARIABLE_LAPLACIAN(obj)                                         \
  (gts_object_is_from_class(obj, gfs_variable_laplacian_class()))
...
#define GFS_HYDROSTATIC_PRESSURE(obj)                                          \
  GTS_OBJECT_CAST(obj, GfsHydrostaticPressure, gfs_hydrostatic_pressure_class())
#define GFS_IS_HYDROSTATIC_PRESSURE(obj)                                       \
  (gts_object_is_from_class(obj, gfs_hydrostatic_pressure_class()))
